...
double shannon_entropy(double lower, double upper, parameters paras);

double int_KL(double nu, void *params);
double KL_divergence(double lower, double upper, parameters paras, parameters paras_approx);
