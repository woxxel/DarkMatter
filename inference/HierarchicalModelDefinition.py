...
class HierarchicalModel:
    ...
    def set_priors(self,priors_init,hierarchical=[]):
        """
    ...
    def set_prior_param(self,priors_init,ct,param,key=None,hierarchical=False,meta=False):
        ...
        if lower_hierarchy_level:
            ...
            self.priors[paramName]['idx_mean'] = self.priors[f"{param}_{priors_init[param]['hierarchical']['params']['loc']}"]['idx']
            self.priors[paramName]['idx_sigma'] = self.priors[f"{param}_{priors_init[param]['hierarchical']['params']['scale']}"]['idx']
